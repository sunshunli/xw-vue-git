<template>
    <div class = "LeEditor">
            ...
            <div ref="textarea" class = "editor__textarea" style="text-align:left"> <!--可使用 min-height 实现编辑区域自动增加高度-->
    ...
    export default {
      ...
      methods: {
          ...
          uploadImg(files,cb){
            ...
            this.ajax.uploadFetch(this.imgUploadUrl,formData).then((result) => {
